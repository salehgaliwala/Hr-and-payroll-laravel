...
class PermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $permissions = [
            ...
            ['name' => 'manage-notification-templates', 'module' => 'notification_templates', 'label' => 'Manage Notification Templates', 'description' => 'Can manage notification templates and settings'],
