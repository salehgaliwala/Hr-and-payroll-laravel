  ...
  return (
    ...
    >
        ...
        formConfig={{
          fields: [
            { 
              ...
              type: 'text', 
              required: true,
              placeholder: t('e.g. Q1 Planning Meeting')
            },
            { 
              name: 'description', 
              label: t('Description'), 
              type: 'textarea',
              placeholder: t('e.g. Quarterly planning session to review goals...')
            },
            { 
              name: 'type_id', 
            ...
            { 
              ...
              type: 'select',
              placeholder: t('Select Meeting Room'),
            ...
            { 
              ...
              type: 'date', 
              required: true,
              placeholder: t('Select Meeting Date')
            },
            { 
              name: 'start_time', 
              label: t('Start Time'), 
            ...
            { 
              ...
              type: 'textarea',
              rows: 4,
              placeholder: t('e.g. 1. Review last quarter results\n2. Set new targets...')
            }
          ],
          modalSize: 'xl'
        }}
      ...
      <Dialog open={!!viewingItem} onOpenChange={() => setViewingItem(null)}>
        {viewingItem && <View meeting={viewingItem} />}
      </Dialog>
    </PageTemplate>
  );
}