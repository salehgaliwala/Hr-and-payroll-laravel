...
export default function Complaints() {
  ...
  const { auth, complaints, complainants, againstEmployees, hrPersonnel, complaintTypes, filters: pageFilters = {}, globalSettings } = usePage().props as any;
        ...
        if (row.is_anonymous) {
          return (
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-400 text-white overflow-hidden shrink-0">
        ...
        formConfig={{
          fields: [
            ...
            { 
              ...
              options: againstEmployeeOptions.filter(opt => opt.value !== ''),
              searchable: true,
