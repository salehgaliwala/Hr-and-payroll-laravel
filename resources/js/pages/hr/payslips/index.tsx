      ...
      render: (value: any, row: any) => (
        <div className="text-sm space-y-1">
          <div className="flex items-center justify-between gap-3">
            <span className="text-xs text-gray-500 dark:text-gray-400">{t('Basic')}</span>
            <span className="font-mono text-xs text-gray-600 dark:text-gray-400">{window.appSettings?.formatCurrency(row.payroll_entry?.basic_salary || 0)}</span>
          </div>
          <div className="flex items-center justify-between gap-3">
            <span className="text-xs text-gray-500 dark:text-gray-400">{t('Gross')}</span>
            <span className="font-mono font-medium text-gray-700 dark:text-gray-300">{window.appSettings?.formatCurrency(row.payroll_entry?.gross_pay || 0)}</span>
          </div>
          <div className="flex items-center justify-between gap-3 border-t border-gray-100 dark:border-gray-700 pt-1">
            <span className="text-xs font-semibold text-gray-700 dark:text-gray-200">{t('Net')}</span>
            <span className="font-mono font-bold text-primary">{window.appSettings?.formatCurrency(row.payroll_entry?.net_pay || 0)}</span>
          </div>
        </div>
      )
    },
