        ...
        <div className="xl:col-span-3">
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid grid-cols-6 mb-4">
              ...
              <TabsTrigger value="banking">{t('Payment')}</TabsTrigger>
            ...
            <TabsContent value="banking">
              <Card>
                <CardHeader>
                  <CardTitle className="text-lg font-semibold text-gray-900 dark:text-gray-100">{t('Payment Information')}</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400 tracking-wide">{t('Payment Option')}</h3>
                      <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mt-1">
                        {employee.employee?.banking_option === 'mobile_wallet'
                          ? t('Mobile Wallet')
                          : employee.employee?.banking_option === 'bank_account'
                            ? t('Bank Account')
                            : '-'}
                      </p>
                    </div>
                    ...
                    {employee.employee?.banking_option === 'mobile_wallet' && (
                      <>
                        <div>
                          <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400 tracking-wide">{t('Wallet Provider')}</h3>
                          <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mt-1">{employee.employee?.wallet_provider || '-'}</p>
                        </div>
                        <div>
                          <h3 className="text-xs font-medium text-gray-500 dark:text-gray-400 tracking-wide">{t('Wallet Phone Number')}</h3>
                          <p className="text-sm font-medium text-gray-900 dark:text-gray-100 mt-1">{employee.employee?.wallet_phone || '-'}</p>
                        </div>
                      </>
                    )}
                          ...
                          <CardContent className="p-4">
                            <div className="flex items-start justify-between">
                              ...
                              <div className="flex flex-wrap gap-2">
                                <Button variant="outline" size="sm" onClick={() => window.open(document.document_url || document.file_path, '_blank')}>
