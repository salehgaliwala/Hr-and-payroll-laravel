                            ...
                            <>
                                <SidebarMenuItem>
                                    <SidebarMenuButton 
                                        ...
                                        className="cursor-pointer"
                                    >
                                        <div className={`flex items-center gap-2 w-full ${state !== "collapsed" ? 'min-w-0' : ''} ${effectivePosition === 'right' ? 'justify-end text-right' : 'justify-start text-left'}`}>
                                            {effectivePosition === 'right' ? (
                                                <>
                                                    <span className="truncate">{state !== "collapsed" ? item.title : ""}</span>
