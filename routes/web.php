...
Route::middleware(['auth', 'verified', 'setting'])->group(function () {
    ...
    Route::middleware('plan.access')->group(function () {
        ...
        Route::middleware('permission:manage-notification-templates')->group(function () {
            ...
            Route::post('hr/recruitment/notification-templates/{notificationTemplate}/preview', [\App\Http\Controllers\NotificationTemplateController::class, 'preview'])->name('hr.recruitment.notification-templates.preview');
        });

        // WhatsApp Templates (Twilio Content API)
        Route::middleware('permission:manage-notification-templates')->group(function () {
            Route::get('hr/recruitment/whatsapp-templates', [\App\Http\Controllers\WhatsappTemplateController::class, 'index'])->name('hr.recruitment.whatsapp-templates.index');
            Route::post('hr/recruitment/whatsapp-templates', [\App\Http\Controllers\WhatsappTemplateController::class, 'store'])->name('hr.recruitment.whatsapp-templates.store');
            Route::put('hr/recruitment/whatsapp-templates/{whatsappTemplate}', [\App\Http\Controllers\WhatsappTemplateController::class, 'update'])->name('hr.recruitment.whatsapp-templates.update');
            Route::delete('hr/recruitment/whatsapp-templates/{whatsappTemplate}', [\App\Http\Controllers\WhatsappTemplateController::class, 'destroy'])->name('hr.recruitment.whatsapp-templates.destroy');
            Route::get('hr/recruitment/whatsapp-templates/{whatsappTemplate}/preview', [\App\Http\Controllers\WhatsappTemplateController::class, 'preview'])->name('hr.recruitment.whatsapp-templates.preview');
        });

        // Candidate Rejection / Notifications
        Route::middleware('permission:manage-candidates')->group(function () {
            Route::post('hr/recruitment/candidates/{candidate}/mark-unsuccessful', [\App\Http\Controllers\CandidateController::class, 'markAsUnsuccessful'])->name('hr.recruitment.candidates.mark-unsuccessful');
            Route::post('hr/recruitment/candidates/{candidate}/resend-rejection', [\App\Http\Controllers\CandidateController::class, 'resendRejectionNotification'])->name('hr.recruitment.candidates.resend-rejection');
        });

        // Notification Settings
        Route::get('hr/recruitment/notification-settings', [\App\Http\Controllers\Settings\NotificationSettingController::class, 'index'])->name('hr.recruitment.notification-settings.index');
        Route::post('hr/recruitment/notification-settings', [\App\Http\Controllers\Settings\NotificationSettingController::class, 'update'])->name('hr.recruitment.notification-settings.update');
        Route::post('hr/recruitment/notification-settings/test-email', [\App\Http\Controllers\Settings\NotificationSettingController::class, 'testEmail'])->name('hr.recruitment.notification-settings.test-email');
        Route::post('hr/recruitment/notification-settings/test-whatsapp', [\App\Http\Controllers\Settings\NotificationSettingController::class, 'testWhatsApp'])->name('hr.recruitment.notification-settings.test-whatsapp');
...
// Twilio Content API Webhook (CSRF excluded - external callback)
Route::post('api/webhooks/twilio-templates', [\App\Http\Controllers\WhatsappTemplateController::class, 'handleWebhook'])->withoutMiddleware([\App\Http\Middleware\VerifyCsrfToken::class])->name('api.webhooks.twilio-templates');
